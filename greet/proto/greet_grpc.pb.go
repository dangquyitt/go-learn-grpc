...
type GreetServiceClient interface {
	Geet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error)
...
func (c *greetServiceClient) Geet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/Geet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	Geet(context.Context, *GreetRequest) (*GreetResponse, error)
...
func (UnimplementedGreetServiceServer) Geet(context.Context, *GreetRequest) (*GreetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Geet not implemented")
}
...
func _GreetService_Geet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).Geet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/Geet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).Geet(ctx, req.(*GreetRequest))
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Geet",
			Handler:    _GreetService_Geet_Handler,
		},
		{
